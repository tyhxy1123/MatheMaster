...
pattern radius = 1pt}
\makeatletter
\pgfutil@ifundefined{pgf@pattern@name@_cv11zgat5}{
\pgfdeclarepatternformonly[\mcThickness,\mcSize]{_cv11zgat5}
{\pgfqpoint{0pt}{0pt}}
...
\draw [color={rgb, 255:red, 11; green, 17; blue, 252 }  ,draw opacity=1 ][line width=3]    (10,205.93) -- (529,43.93) ;
...
\draw  [color={rgb, 255:red, 245; green, 166; blue, 35 }  ,draw opacity=1 ][pattern=_cv11zgat5,pattern size=6pt,pattern thickness=0.75pt,pattern radius=0pt, pattern color={rgb, 255:red, 245; green, 166; blue, 35}][line width=1.5]  (405.5,29.5) -- (452.86,13.48) -- (468.89,60.84) -- (421.52,76.86) -- cycle ;
...
% Text Node
\draw (525,22) node   {$Y_{i} -( \alpha +\beta \cdot x_{i})$};
% Text Node
\draw (55,35) node   {$\alpha +\beta \cdot x_{i}$};
