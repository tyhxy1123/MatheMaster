...
Sei $A$ $m$-akkretiv vom Typ $\omega\in\R$ auf einem Banachraum $X$. Dann gilt
\begin{align*}
...
\end{array}\right.
\end{align*}
bzw. auch Eulerlösung. Sei $t\geq0$ und betrachte auf $[0,t]$ äquidistante Partitionen der Form:
\begin{align*}
