...
\end{align*}
Schreibweise: $g=:\frac{\partial u}{\partial x_i}$ ist die schwache partielle Ableitung nach $x_i$\\
...
Es gelte $u_n\stackrel{n\to\infty}{\longrightarrow} u$ in $L^2(\Omega)$. Zu zeigen:
\begin{align*}
\E(u)\leq\liminf\limits_{n\to\infty}\E(u_n)
\end{align*}
Sei O.B.d.A. $\liminf\limits_{n\to\infty}\E(U-n)<+\infty$ und, nach Übergang zu Teilfolge, folgt
\begin{align*}
