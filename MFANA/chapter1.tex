...
\begin{erinnerung}
	Eine Funktion $f\colon X\to\R$ heißt \define{sublinear}
	\begin{align*}
...
\begin{lemma}\label{lemmaSubgradientMAkkretivHilfslemma}
...
\begin{theorem}[Subgradienten sind M-akkretiv]\label{theoremSubgradientMAkkretiv}\enter
