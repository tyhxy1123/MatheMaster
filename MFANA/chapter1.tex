...
\begin{align*}
\Vert u-v_n\Vert\stackrel{n\to\infty}{\longrightarrow}\dist(u,C).
\end{align*}
(Diese Folge existiert nach Definition des Infimums.) Mit der Parallelogrammidentität gilt:
\begin{align*}
\forall x,y\in H:\Vert x\Vert+\Vert y\Vert^2\stackeq{Parallelo}\frac{1}{2}\cdot\left(\Vert x+y\Vert^2+\Vert x-y\Vert^2\right)
\end{align*}
Setze $x:=u-v_n$ und $y=u-v_n$. To be continued...
