...
\P\big(X\text{ trifft }-B\text{ vor }+A\big)&=\frac{B}{A+B}\\
\end{align*}
...
&=\E\Big[\underbrace{X^2_{\tau_A}}_{=A^2}\cdot\indi_{\lbrace\tau_A<\tau_B\rbrace}+\underbrace{X^2_{\tau_B}}_{=B^2}\cdot\indi_{\lbrace\tau_A>\tau_B\rbrace}\Big]\\
