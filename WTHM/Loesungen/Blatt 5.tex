...
\begin{proof}
	...
	\begin{align*}
		...
		\overset{\text{Trafo}}&=
		\int\limits_\R\exp\big(i\cdot x\cdot w\cdot u)\cdot f_{X\cdot W}(u)\d u
		\qquad\forall u\in\R
	\end{align*}
	...
	\begin{align*}
		f_{X\cdot W}(u)
		\overset{\text{Stoch}}&=
		\int\limits_\R\frac{1}{|t|}\cdot f_X(t)\cdot f_W\left(\frac{u}{t}\right)\d u\\
		\overset{\sim\Nor(0,1)}&=
		\int\limits_\R\frac{1}{|t|}\cdot\frac{1}{\sqrt{2\cdot\pi}}\cdot\exp\left(-\frac{1}{2}\cdot t^2\right)\cdot\frac{1}{\sqrt{2\cdot\pi}}\cdot\exp\left(-\frac{1}{2}\cdot\frac{u^2}{t^2}\right)\d t\\
		&=\frac{1}{2\cdot\pi}\cdot\int\limits_\R\frac{1}{|t|}\cdot\exp\left(-\frac{1}{2}\cdot\left(t^2+\frac{u^2}{t^2}\right)\right)\d t\\
		&=...
	\end{align*}
