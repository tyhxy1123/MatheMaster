...
\begin{align*}
	...
	&\leq\sum\limits_{k=0}^\infty \left(\frac{p}{q}\right)^k\\
...
\begin{proof}
	...
	\end{align*}
	Also ist $M_\infty$ fast sicher der Grenzwert von $M_n$. Nun folgt der Rest sehr wie im Beweis vom Professor.\end{proof}
