...
\begin{align*}
	...
	&\stackrel{\eqref{eqAufgabe3bObere}}{\leq}\sum\limits_{k=1}^\infty \left(\frac{p}{q}\right)^k\\
	&\stackeq{q >p}\frac{\frac{p}{q}}{1-\left(\frac{p}{q}\right)^k} \\
	&= \frac{p}{q-p}
\end{align*}
