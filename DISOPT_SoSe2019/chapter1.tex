...
\begin{itemize}
	...
	\item Starke Dualität\\
		...
		\begin{enumerate}
			...
			\item mk
		\end{enumerate} 
		% hier fehlt ganz viel hab ich in vim irgendwie gelöscht
	\item Ecken und Lösungen\\
		...
		$\iff$ Sei 
		\begin{equation*}
			I = \{i = 1 ,\dots, n | \ħat{x}_{i} \geq 0 \} = \supp(\hat{x})
		\end{equation*} 
	...
	$\implies$ rang($A_{\cdot,I} $  )= |I| \leq m \\
		%what ist das in der folgenden Zeile
	...
	\item Basen\\
		...
		\end{equation*} % something to add here
\end{itemize} 
