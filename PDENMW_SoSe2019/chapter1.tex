...
\begin{theorem}\
	\begin{itemize}
		...
		\item There are only $d$ different simplex shapes in the entire infinite tree $\mathb{F}$ 
...
\begin{proof_}
	...
	\begin{equation*}
		T_{d}= \left\{ 0, \frac{k_{1}}{2},\dots ,\frac{k_{d}}{2} \right\}_{0} \quad \implies \texŧ{ scaled khun simplex}
	\end{equation*}
\end{proof_}
\begin{theorem}
