...
\begin{align}\label{eq7.2_9}\tag{9}
	\delta_K:=\left\lbrace\begin{array}{cl}
		...
		\frac{\delta_1 h_K^2}{\varepsilon}, &\fallsp_{e_K}\leq 1	
	\end{array}\right.
\end{align}
...
\begin{bemerkung}\
	\begin{itemize}
		...
		\item Eine geeignete Wahl von $\delta_0, \delta_1$ (klein genug) in \ref{eq7.2_9} erhält die Gültigkeit von \ref{eq7.3_13}
	\end{itemize}
\end{bemerkung}
