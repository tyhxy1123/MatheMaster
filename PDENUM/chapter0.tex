...
\begin{proof}
	...
	\begin{align*}
		\int_{-1}^1 \varphi v' dx &= \int_{-1}^0 \varphi v' dx + \int_{0}^1 \varphi v' dx \\
															&\stackeq{part. Int.} ~~~ \big[\varphi v\big]_{-1}^0 - \int_{-1}^0 (-1) v dx + \big[\varphi v\big]_{0}^1 - \int_{0}^1 (1) v dx \\
															&\stackeq{v \equiv 0 \text{ auf Rand}} ~~~ - \int_{-1}^0 (-1) v dx - \int_{0}^1 (1) v dx \\
															&\stackeq{Def} - \int_{-1}^1 \varphi'(x)vdx
	\end{align*}
\end{proof}
\end{beisp}
