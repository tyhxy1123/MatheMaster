...
Seien $\Omega_1,\Omega_2\subseteq\Omega$ zwei nichtleere, offene, beschränkte und disjunkte Teilmengen von $\Omega$ mit stückweise glattem Rand. Gelte $\overline{\Omega}=\overline{\Omega_1}\cup\overline{\Omega_2}$.
...
$\Omega$ hat einen \textbf{Lipschitz-Rand} $:\gdw\\\exists N\in\N,\exists U_1,\ldots,U_N\subseteq\R^d:$
\begin{enumerate}
\item $
\begin{aligned}
...
\end{aligned}$
 ist darstellbar als Graoh einer Lipschitz-stetigen Funktion
\end{enumerate}
