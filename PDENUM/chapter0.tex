...
%TODO Warum ist das hier zentriert???
\begin{enumerate}[label=(\roman*)]
\item $\begin{aligned}
\overline{\Omega}=\bigcup\limits_{i=1}^N \overline{K_i}
\end{aligned}$ \hspace{2cm} \input{triang_example1}
\item $\begin{aligned}
...
\begin{beispiel}\\
%TODO Hier könnte man eine Abbildung einfügen; und mache Gleichungen unten schöner
\input{plot_affin_equiv_triang}\\
\begin{align*}
