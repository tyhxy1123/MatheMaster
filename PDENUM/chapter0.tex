...
&\quad+c\cdot\left(\sum\limits_{E\in\Sigma_h}\big\Vert\nabla u_h\cdot n_E]_E\big\Vert^2_{0,2,E}\right)\cdot\underbrace{\left(\sum\limits_{E\in\Sigma_h}|v|^2_{1,2,\tilde{\omega}_E}\right)^{\frac{1}{2}}}_{\leq c\cdot |v|_{1,2,\Omega}\text{ wobei $c$ Form-regulär ist}}\\
&\leq
...
Sei $T\in\T_h$ auf $E\in\Sigma_h$. Wir setzen
\begin{align*}
\psi_T:=27\cdot\varphi_{z_1}\cdot\varphi_{z_2}\cdot\varphi_{z_3}
\end{align*}
wobei $z_1,z_2,z_3$ beliebige Knoten von $T$ sind. Definiere weiterhin
\begin{align*}
\psi_E:=4\cdot\varphi_{z_1}\cdot\varphi_{z_2}
\end{align*}
wobei $z_1,z_2$ am Ende der Kante $E$ sind.
\end{definition}
...
\begin{theorem}
Sei $T\in\T_h,E\in\mathcal{E}_H, v\in P_k(T), \sigma\in P_k(E)$. Dann gilt:
\begin{align*}
c_1\cdot\Vert v\Vert_{0,2,T}
&\leq\left(\int\limits_T\psi_T\cdot v^2(x)\d x\right)^{\frac{1}{2}}
&\leq&\Vert v\Vert_{0,2,T}\\
c_2\cdot h_T^{-1}\cdot\big\Vert\psi_T v\big\Vert_{0,2,T}
&\leq\big|\psi_T v\big|_{1,2,T}
&\leq& c_3\cdot h_T^{-1}\cdot\big\Vert\psi_T v\big\Vert_{0,2,E}\\
c_4\cdot\Vert\sigma\Vert_{0,2,E}
&\leq\left(\int\limits_E\psi_E\cdot\sigma^2\d s\right)^{\frac{1}{2}}
&\leq&\Vert\sigma\Vert_{0,2,E}\\
...
\begin{align*}
&c^2_1\cdot\big\Vert f_h+\Delta u_h\big\Vert_{0,2,T}\\
...
&~+h_E^{\frac{1}{2}}\cdot\left(\sum\limits_{T\in\omega_E}\big\Vert f+\Delta u_h\big\Vert^2_{0,2,T}\right)^{\frac{1}{2}}\cdot\big\Vert[\nabla u_h\cdot n_E]_E\big\Vert_{0,2,E}\\
