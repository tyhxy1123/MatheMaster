...
\subsection{Das nichtkonforme $P_1$-Element}
...
\begin{align*}
\Vert u-u_h\Vert\leq\Vert u-v_h\Vert+\Vert v_h-u_h\Vert_h\leq\left(1+\frac{M}{\alpha}\right)\cdot\Vert u-v_h\Vert_h+\frac{1}{\alpha}\cdot\sup\limits_{z_h\in V_h}\frac{a_h\big(u,z_h\big)-f_h\big(z_h\big)}{\Vert z_h\Vert_h}
\end{align*}
