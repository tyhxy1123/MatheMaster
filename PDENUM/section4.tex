...
\begin{lemma}[Deny-Lions]\label{lemma4.11DenyLions}\enter
	...
	\begin{align*}
		\exists c(K)>0:\inf\limits_{P\in P_r(K)}\Vert v-P\Vert_{r+1,p,K}\leq c(K)\cdot |v|_{r+1,p,K}\qquad\forall v\in W^{r+1,p}(K) % war in der VL $v+P$, aber Minus ist äquivalent
	\end{align*}
\end{lemma}
