...
%ToDo: fix enumerate (1), (2), ...
%ToDo: Was ist \G?
\begin{definition} %2.7
$\G_0\subseteq\G$ heißt Basis von $\G:\Longleftrightarrow\forall G\in\G:G$ ist Vereinigung von Mengen aus $\G_0$, so genannte \textbf{$\G_0$-Mengen}.
\end{definition}
...
&\implies G\stackrel{\ref{proof2.9Sternchen}}{\supseteq}
