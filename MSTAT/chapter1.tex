...
\begin{satz}[Donskur]\label{satz7.16Donskur}%\enter
...
Aus \eqref{eqProof7.16Plus} und \eqref{eqCrUngleichung} mit $r=4$ und $m=3$ folgt wegen $|\lceil n\cdot s-\lceil n\cdot s\rceil|\leq1$:
\begin{align*}
\E\Big[\big|X_n(s)-X_n(t)\big|^4\Big]
\overset{}{\leq}
