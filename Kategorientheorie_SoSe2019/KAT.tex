...
\input{local_theoremenvironments}
...
\author{
	Vorlesung:  Prof. Dr. Reinhard Pöschel\\
	Mitschrift: Pascal Lehmann \& Willi Sontopski
}
\date{\today}
...
\begin{document}
	...
	\maketitle
	\epigraph{... es wird schon gutgehen...}{\textit{Prof. Pöschel zur Mengenlehre}}
	%\newpage
	\doclicenseThis
	\tableofcontents
	...
	\input{chapter1} % Category, examples
	\input{chapter2} % Construction with categories
	\input{chapter3} % Functors and natural transformations
	\input{chapter4} % Special morphisms and objets in cats
