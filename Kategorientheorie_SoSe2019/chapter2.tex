...
\begin{bemerkung}[zum Begriff verallgemeinerter Elemente]\
	\begin{enumerate}[label=] %TODO Write better german here!
		...
		\item Antwort: $\Cat(A,K), f: \set{1} \to A=$ Elemente von $K$ und $\Cat(A,K) = $ Menge $K$ %TODO verfiy this! not sure about it.
