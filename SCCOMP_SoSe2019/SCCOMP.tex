...
\input{\directoryPrefix theoremenvironments_english_fancy}
\input{\directoryPrefix font}
\input{\directoryPrefix commands}
%\input{\directoryPrefix commands_Willi}
%\input{local_packages_commands.tex} % lokale Commands und packages werden auch ausgelagert. Lokal bedeutet nur diese Vorlesung betreffend.
