...
\begin{definition}\label{defFormel}
...
\begin{proof}
	...
	Da $\E$ die drei Bedingungen in Definition \ref{defFormel} erfüllt, gilt $\L(\RR)\subseteq\E$, da $\L(\RR)$ nach Definition die kleinste solche Menge ist.
\end{proof}
...
\section{Das Testen auf Erfüllbarkeit}