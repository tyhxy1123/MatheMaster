...
\author{
	Vorlesung:  Prof. Dr. Steffen Hölldobler\\
	%Zusammenfasssung (kein Skript!)\\
...
\begin{document}
	...
	\TemplateDozentSagtNein{Theoretische Informatik und Logik}
	
	\vspace{5cm}
Die Folien von Prof. Hölldobler (passwortgeschützt) findest du hier:
\url{https://iccl.inf.tu-dresden.de/web/Theoretische_Informatik_und_Logik(SS2019)}
