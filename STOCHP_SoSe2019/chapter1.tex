...
\begin{definition}\label{def:1.3.5}
	...
	Dann ist $\big(Z_{t_1},\ldots,Z_{t_n}\big)$ ein Zufallsvektor mit Werten im Produkt-Messraum $\big(S^n,\B^n\big)$ und besitzt folglich eine Verteilung.
...
\subsection*{Wiederholdung: Gauß-Verteilung}
\begin{defi}
