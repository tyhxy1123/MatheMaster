...
\begin{beisp}[Herleitung der \define{Fokker-Planck-Diffusionsgleichung} der Diffusionstheorie (Anfang des 20. Jhd.)]\enter
	...
	\begin{align*}
		...
		\forall x\neq0.
	\end{align*}
	\begin{aufgabenr}[1.2 Teil 1, \texorpdfstring{\hyperref[loes:1]{Lösung siehe Anhang}}{Lösung siehe Anhang}]\label{aufg:1.2Teil1}\enter
	...
	\begin{aufgabenr}[1.2 Teil 2, \texorpdfstring{\hyperref[loes:1]{Lösung siehe Anhang}}{Lösung siehe Anhang}]\label{aufg:1.2Teil2}\enter
...
\begin{aufgabenr}[1.3.2.7 Teil 1, \texorpdfstring{\hyperref[loes:2]{Lösung siehe Anhang}}{Lösung siehe Anhang}]\label{aufg:1.3.2.7Teil1}\enter
	Zeigen Sie:
	\begin{enumerate}
...
\begin{beisp}
	...
	\begin{aufgabenr}[1.3.2.7 Teil 2, \texorpdfstring{\hyperref[loes:2]{Lösung siehe Anhang}}{Lösung siehe Anhang}]\label{aufg:1.3.2.7Teil2}\enter
