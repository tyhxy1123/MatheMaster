...
Aus \undefine{Schur's Produkt-Theorem} folgt, dass das Hadamard-Produkt
\begin{align*}
...
\begin{proof}
	\betone{Zeige, dass $K_1$ positiv semidefinit ist:}\\
	...
	\end{align}
	\betone{Induktionsanfang $n=1$:}
	\begin{align*}
		D_1(x_1)\overset{\Def}{=}\det(x_1)=x_1=x_1\mal\underbrace{\prod\limits_{j=2}^n\klammern{x_j-x_1}}_{=1}
	\end{align*}
	\betone{Induktionsvoraussetzung:} Gelte \eqref{eq:Lsg20Indu} für ein beliebiges, aber festes $n\in\N$.\nl
	\betone{Induktionsschritt:} $n\to n+1$
	\begin{align*}
	...
	\betone{Zeige, dass $K_2$ positiv semidefinit ist:}
	\begin{align*}
		K_2(x,y)
		\overset{\Def}&{=}
