...
\DeclareMathOperator{\Bild}{Bild}        % Bild einer Matrix / Funktion
\renewcommand{\d}{\mathrm{d}}            % Differential d ohne Space
\newcommand{\defiff}{\vcentcolon\Longleftrightarrow} % per Definition genau dann, wenn
...
\DeclareMathOperator{\Kern}{Kern}        % Kern einer Matrix / Funktion
...
\DeclareMathOperator{\Spur}{Spur}        % Spur einer Matrix
\DeclareMathOperator{\supp}{supp}        % Träger
\newcommand{\symDiff}{\,\triangle\,}        % symmetrische Differenz
...
\xDeclarePairedDelimiter{\eckigeKlammern}{[}{]}
...
%Links
\newcommand{\email}[1]{\texttt{\href{mailto:#1}{#1}}} % Hyperlink für E-Mails
\newcommand{\link}[1]{\texttt{\href{#1}{#1}}}          % Hyperlink ins WWW
