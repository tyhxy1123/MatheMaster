...
\begin{proposition}
    ...
    \begin{enumerate}[label=(\arabic*)]
        ...
        \item
            ...
            Ist $\Delta$ eine funktorielle Abbildung bzgl.~$(\P, \M)$, so gilt
            für $\varphi\colon P\to M,\, p\mapsto \Delta(0, p)$ stets $\Delta
            = \Dphi$.
    \end{enumerate}
    \begin{proof}
        ...
        Seien $p, q\in P$.
        Aus \autoref{prop:MeasSetupÜberGruppe} folgt, dass $\Delta$ Dimensionsfunktion ist, also gilt (da $0\leq p \leq q$):
        \begin{align*}
            \Dphi(p, q)
                &= (\varphi p)^{-1}*\varphi q \\
