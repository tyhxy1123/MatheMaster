...
%Hier die 13. Vorlesung (20.11.2018). Kannst du gern umschreiben @Lukas. 



\begin{bemerkung}
für $x,y\in[0,\infty]$ mit $<\leq y$ ist also $\delta(x,y)$ das kleinste Element $t$ in $\big([0,\infty],\leq\big)$ mit $x+t=y$, d.h. $t$ ist die kleinste ``Ergänzung'' von $x$ zu $y$ im natürlich geordneten Monoid $\big([0,\infty],+,0\big)$\\
